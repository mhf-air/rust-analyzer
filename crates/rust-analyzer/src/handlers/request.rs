...
pub(crate) fn handle_completion(
    ...
    lsp_types::CompletionParams {
        mut text_document_position_params,
        context,
        ..
    }: lsp_types::CompletionParams,
    ...
    u_to_rs_url(
        &snap.config.default_root_path(),
        &mut text_document_position_params.text_document.uri,
    );
    u_to_rs_position(&snap, &mut text_document_position_params);
    ...
    let url = text_document_position_params.text_document.uri.clone();
    let mut items = to_proto::completion_items(
        &snap.config,
